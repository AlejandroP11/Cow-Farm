...
public class Tractor extends Jugador{
    ...
    public void paint(Graphics g, int juX, int juY){
        ...
        try{
            obj.drawImage(getToolkit().getImage("C:\\Users\\34653\\OneDrive\\Documentos\\NetBeansProjects\\EsquivandoVacas\\Imagenes\\tractor.png"), juX, juY,this);   //dibuja el coche en la vetana
        }
        catch(Exception e){
