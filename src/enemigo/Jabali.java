...
public class Jabali extends Enemigo{
    ...
    public void paint(Graphics g, int vX, int vY) {
        ...
        try{
            obj.drawImage(getToolkit().getImage("C:\\Users\\34653\\OneDrive\\Documentos\\NetBeansProjects\\EsquivandoVacas\\Imagenes\\jabali.png"), vX, vY,this); //dibuja al jabali
        }
        catch(Exception e){
    ...
    public void paintS(Graphics g, int juX, int juY) {
        ...
        obj.setRenderingHint(RenderingHints.KEY_ANTIALIASING, RenderingHints.VALUE_ANTIALIAS_ON); //usamos la clase RenderingHints para renderizar
        try{
            obj.drawImage(getToolkit().getImage("C:\\Users\\34653\\OneDrive\\Documentos\\NetBeansProjects\\EsquivandoVacas\\Imagenes\\jabaliPontente.png"), juX, juY,this); //dibuja al jabali
        }
        catch(Exception e){
            System.out.println(e);
        }
