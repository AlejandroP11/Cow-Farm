...
public class Dron extends Jugador{
    @Override
    public void paint(Graphics g, int juX, int juY) {
        ...
        try{
            obj.drawImage(getToolkit().getImage("C:\\Users\\34653\\OneDrive\\Documentos\\NetBeansProjects\\EsquivandoVacas\\Imagenes\\dron.png"), juX, juY,this);   //dibuja el coche en la vetana
        }
        catch(Exception e){
